...
{
	public class QueueServicingGuestDetailResponse
	{
		...
		[Newtonsoft.Json.JsonProperty(PropertyName = "user_serving")]
		public string UserServing { get; set; }

		[Newtonsoft.Json.JsonProperty(PropertyName = "service_time")]
