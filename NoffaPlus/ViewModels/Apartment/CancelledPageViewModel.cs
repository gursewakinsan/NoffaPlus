...
{
    public class CancelledPageViewModel : BaseViewModel
    {
		#region Constructor.
		public CancelledPageViewModel(INavigation navigation)
		{
		...
		public List<ApartmentCommunityTicketModel> CancelledList => Helper.Helper.ApartmentCommunityTicketInfo.CancelledList;
