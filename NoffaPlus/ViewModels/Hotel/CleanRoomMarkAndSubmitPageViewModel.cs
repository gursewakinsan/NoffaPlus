...
{
	public class CleanRoomMarkAndSubmitPageViewModel : BaseViewModel
	{
		#region Constructor.
		public CleanRoomMarkAndSubmitPageViewModel(INavigation navigation)
		{
		...
		private async Task ExecuteUpdateRoomCleaningCommand()
		{
			if (IsInspection && isCleanRoom && IsMinibar)
			{
				...
				await service.UpdateRoomCleaningAsync(new Models.UpdateRoomCleaningRequest()
				{
